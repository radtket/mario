...
var kaboom = function () {
  ...
  var init_math = __esm({
    'src/math.ts': function srcMathTs() {
  ...
  var init_utils = __esm({
    'src/utils.ts': function srcUtilsTs() {
  ...
  function appInit() {
    ...
    var app = {
      canvas: (_gconf$canvas = gconf.canvas) !== null && _gconf$canvas !== void 0 ? _gconf$canvas : function () {
        var _gconf$root;
  ...
  var init_burp = __esm({
    'src/assets/burp.mp3': function srcAssetsBurpMp3() {
  ...
  var init_audio = __esm({
    'src/audio.ts': function srcAudioTs() {
      init_math();
      init_burp();
      MIN_GAIN = 0;
      MAX_GAIN = 3;
  ...
  var init_unscii_8x8 = __esm({
    'src/assets/unscii_8x8.png': function srcAssetsUnscii_8x8Png() {
  ...
  var init_mark = __esm({
    'src/assets/mark.png': function srcAssetsMarkPng() {
  ...
  var init_assets = __esm({
    'src/assets.ts': function srcAssetsTs() {
      init_math();
      init_unscii_8x8();
      init_mark();
  ...
  var init_logger = __esm({
    'src/logger.ts': function srcLoggerTs() {
      init_math();
      LOG_SIZE = 16;
  ...
  var require_kaboom = __commonJS({
    'src/kaboom.ts': function srcKaboomTs(exports, module) {
      init_math();
      init_gfx();
      init_app();
      init_audio();
      ...
      var IDList = /*#__PURE__*/function (_Map) {
        ...
        var _super = _createSuper(IDList);
      ...
      module.exports = function () {
        ...
        function addLevel(map2, conf) {
          ...
          var level = {
            ...
            destroy: function destroy() {
              var _iterator12 = _createForOfIteratorHelper(objs),
                  _step12;
        ...
        if (gconf.plugins) {
          var _iterator13 = _createForOfIteratorHelper(gconf.plugins),
              _step13;

          try {
            for (_iterator13.s(); !(_step13 = _iterator13.n()).done;) {
              var src = _step13.value;
              var map2 = src(ctx);
...
loadSprite("coin", "coin.png"); // // define some constants

var JUMP_FORCE = 320;
var MOVE_SPEED = 120;
var FALL_DEATH = 640; // define layers, draw "ui" on top, and "game" is the default layer

layers(["game", "ui"], "game"); // camera will ignore "ui" layer

camIgnore(["ui"]); // add level to scene
...
var player = add([sprite("guy"), pos(0, 0), scale(1), // makes it fall to gravity and jumpable
body(), // as we defined above
big()]); // action() runs every frame
...
player.collides("apple", function (a) {
  destroy(a); // as we defined in the big() component
...
},{"./kaboom":"kaboom.js"}],"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
